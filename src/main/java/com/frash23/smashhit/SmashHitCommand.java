...
class SmashHitCommand implements CommandExecutor
{
    ...
    public boolean onCommand( CommandSender sender, Command cmd, String label, String[] args )
    {
        ...
        switch ( subcmd.toLowerCase() )
        {
            ...
            default:
                sender.sendMessage( new String[]{ "§2SmashHit v§a1.0-RC2", "§a/bss help §7- Show this message", "§a/bss reload §7- Reload config & restart hit interception", "§a/bss toggle §7- Disable/enable hit interception" } );
                return true;
        }
    }
}
