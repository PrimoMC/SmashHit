package com.frash23.smashhit.Particle;
...
public enum ParticleEffect
{
    ...
    private static boolean isLongDistance( Location location, List<Player> players )
    {
        ...
        for ( Player player : players )
        {
            ...
            if ( playerLocation.distanceSquared( location ) > 256 && playerLocation.distanceSquared( location ) < 65536 )
            {
                return true;
            }
        }
    ...
    public static final class ParticlePacket
    {
        ...
        private static WrapperPlayServerWorldParticles protocolPacket;
        ...
        public static void initialize() throws VersionIncompatibleException
        {
            ...
            protocolPacket = new WrapperPlayServerWorldParticles();
            initialized = true;
        }
        ...
        {
            protocolPacket.setParticleType( EnumWrappers.Particle.getById( effect.getId() ) );
            protocolPacket.setLongDistance( true );
            if ( data != null )
            {
                protocolPacket.setData( data.getPacketData() );
            }
            protocolPacket.setX( (float) center.getX() );
            protocolPacket.setY( (float) center.getY() );
            protocolPacket.setZ( (float) center.getZ() );
            protocolPacket.setOffsetX( offsetX );
            protocolPacket.setOffsetY( offsetY );
            protocolPacket.setOffsetZ( offsetZ );
            protocolPacket.setNumberOfParticles( amount );
            protocolPacket.setParticleData( speed );
        }
        ...
        public void sendTo( Location center, Player player ) throws PacketInstantiationException, PacketSendingException
        {
            ...
            protocolPacket.sendPacket( player );
